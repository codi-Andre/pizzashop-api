...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "order-items" ADD CONSTRAINT "order-items_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
